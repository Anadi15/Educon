...
public class TeacherDetail extends AppCompatActivity implements View.OnClickListener{
    ...
    private static final String REGISTER_URL = "http://anadi.esy.es/teacherdetail.php";
    ...
    private void uploadImage(){
        class UploadImage extends AsyncTask<Bitmap,Void,String>{
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                loading = ProgressDialog.show(TeacherDetail.this, "Uploading...", null,true,true);
            }
 ...
 private void confirmAddTeacher(){
    ...
    private void register(String name, String email, String fathername,String  mothername,String gender,String date,String month,String year,String address,String enrollment) {
        class RegisterUser extends AsyncTask<String, Void, String>{
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                loading = ProgressDialog.show(TeacherDetail.this, "Please Wait",null, true, true);
            }
